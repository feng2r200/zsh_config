...
alias 'mvn!'='mvnd -f $(git rev-parse --show-toplevel 2>/dev/null || echo ".")/pom.xml'

# aliases
alias mvnag='mvnd archetype:generate -DarchetypeGroupId=com.github.ngeor -DarchetypeArtifactId=archetype-quickstart-jdk8 -DarchetypeVersion=2.8.1'
alias mvnboot='mvnd spring-boot:run'
alias mvnc='mvnd clean'
alias mvncd='mvnd clean deploy'
alias mvnce='mvnd clean eclipse:clean eclipse:eclipse'
alias mvnci='mvnd clean install'
alias mvncie='mvnd clean install eclipse:eclipse'
alias mvncini='mvnd clean initialize'
alias mvncist='mvnd clean install -DskipTests'
alias mvncisto='mvnd clean install -DskipTests --offline'
alias mvncom='mvnd compile'
alias mvncp='mvnd clean package'
alias mvnct='mvnd clean test'
alias mvncv='mvnd clean verify'
alias mvncvst='mvnd clean verify -DskipTests'
alias mvndocs='mvnd dependency:resolve -Dclassifier=javadoc'
alias mvndt='mvnd dependency:tree'
alias mvnfmt='mvnd fmt:format'
alias mvnqdev='mvnd quarkus:dev'
alias mvnsrc='mvnd dependency:sources'
alias mvn-updates='mvnd versions:display-dependency-updates'
